...
TEXT_JOIN = (
    ...
    "<i>(Списание происходит автоматически раз в 30 дней. Отменить можно в любой момент в этом боте).</i>\n\n"
...
TEXT_CABINET = (
    ...
    "💳 <b>Управление:</b> Через GetCourse\n\n"
    "Если вы захотите приостановить участие, напишите в поддержку. Но мы будем скучать!"
)
